          ...
          <div className="mt-auto flex items-end justify-between gap-4 border-t border-white/5 pt-4">
            <div className="min-w-0">
              ...
              <div className="flex items-baseline gap-1">
                ...
                {product.billing && (
                  <span className="text-[11px] text-gray-500">/{product.billing}</span>
                )}
              </div>
            ...
            <button
              type="button"
              className="group/btn relative inline-flex items-center justify-center gap-1.5 overflow-hidden rounded-full bg-gradient-to-br from-indigo-500 via-violet-500 to-fuchsia-500 px-4 py-2 text-xs font-medium text-white shadow-[inset_0_1px_0_0_rgba(255,255,255,0.25),0_6px_20px_-6px_rgba(139,92,246,0.6)] transition-all hover:scale-[1.04]"
            >
